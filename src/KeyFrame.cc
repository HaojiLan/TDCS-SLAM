...
KeyFrame::KeyFrame():
        ...
        mfGridElementWidthInv(0), mfGridElementHeightInv(0),InitialKFflag(false),
...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    fx(F.fx), fy(F.fy), cx(F.cx), cy(F.cy), invfx(F.invfx), invfy(F.invfy), InitialKFflag(false),
...
void KeyFrame::ComputeBoW(const vector<bool> &ComputeFlag)
{
