...
public:
    ...
    void ComputeBoW(const std::vector<bool> &ComputeFlag);
...
public:
   ...
   // const cv::Mat mDescriptors;
    ...
    // for descitor computation in localmapping thread
    std::vector < std::vector<cv::KeyPoint> > mallKeypoint;
    std::vector<cv::Mat> mvWorkingMat;  
    vector<bool> mbCompute;
